...
// --- NUEVO: Componente para la fila "esqueleto" de Catálogos ---
// Recibe el número de columnas para adaptarse a cualquier catálogo.
const CatalogSkeletonRow = ({ column_count }) => (
    <tr className="animate-pulse">
        {/* Genera celdas de esqueleto basadas en el número de columnas */}
...
const CatalogCrud = ({ catalogInfo, onBack }) => {
    ...
    const loadData = async () => {
        ...
        setError(null);
        try {
            // Simulación de carga para ver el efecto
        ...
        <div>
            ...
            <div className="bg-dark-surface rounded-lg shadow-lg overflow-hidden">
                <table className="min-w-full">
                    ...
                    {isLoading ? (
                        [...Array(5)].map((_, index) => <CatalogSkeletonRow key={index} column_count={columns.length} />)
                    ) : (
