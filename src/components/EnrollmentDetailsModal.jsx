...
const DetailField = ({ label, value, children, className = '' }) => (
    <div className={className}>
        ...
        {children ? <div className="text-base text-dark-text-primary mt-1">{children}</div> : <p className="text-base text-dark-text-primary">{value || 'No especificado'}</p>}
    </div>
);
                ...
                <div className="overflow-y-auto p-8 pt-0 space-y-6">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-x-4 gap-y-6">
                            ...
                            <DetailField label="Fecha de Matrícula" value={formatDate(enrollment.enrollmentDate)} className="md:col-span-3"/>
                        </div>
                    </div>
