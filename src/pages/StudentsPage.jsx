...
const StudentsPage = () => {
  ...
  return (
    <div>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8">
        ...
        <div className="flex items-center gap-4 mt-4 md:mt-0">
          <div className="relative">
            ...
            <input type="text" placeholder="Buscar estudiante..." className="w-full bg-dark-surface border border-dark-border rounded-lg py-2 pl-10 pr-4 focus:outline-none focus:ring-2 focus:ring-brand-accent text-dark-text-primary" />
          </div>
      ...
      {isAddModalOpen && (
        <StudentAddModal onClose={() => setIsAddModalOpen(false)} onSave={handleCreateStudent} catalogs={catalogs} />
      )}
      {isEditModalOpen && (
