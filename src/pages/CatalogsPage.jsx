...
const catalogItems = [
    ...
    // --- CATÁLOGO COMPLEJO: INSTITUCIÓN ---
    {
        ...
        displayColumns: [
            ...
            // === CAMBIO: Se añadió la propiedad 'displayAs' para indicar que se renderice como píldora ===
            { header: 'Tipo', field: 'institutionType.description', headerAlign: 'center', cellAlign: 'center', displayAs: 'pill' }
        ]
    },
];
